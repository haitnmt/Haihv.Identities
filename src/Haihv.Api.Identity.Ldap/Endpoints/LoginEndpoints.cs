...
using Haihv.Api.Identity.Ldap.Extensions;
using Haihv.Api.Identity.Ldap.Interfaces;
using Haihv.Api.Identity.Ldap.Models;
using Haihv.Api.Identity.Ldap.Services;
using Microsoft.AspNetCore.Mvc;
using LoginRequest = Haihv.Api.Identity.Ldap.Models.LoginRequest;
using ILogger = Serilog.ILogger;
namespace Haihv.Api.Identity.Ldap.Endpoints;
...
public static class LoginEndpoints
{
        ...
        HttpContext httpContext)
    {
        ...
        return await result.Match<Task<IResult>>(async s =>  
            {
